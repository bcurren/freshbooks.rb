...
Gem::Specification.new do |s|
  ...
  s.summary = %q{}
  s.test_files = ["test/live_connection_test.rb","test/schema/test_definition.rb", "test/schema/test_mixin.rb", "test/test_base.rb", "test/test_connection.rb", "test/test_helper.rb", "test/test_invoice.rb", "test/test_expense.rb", "test/test_payment.rb", "test/test_list_proxy.rb", "test/test_page.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<fakeweb>, [">= 1.8.0"])
    else
