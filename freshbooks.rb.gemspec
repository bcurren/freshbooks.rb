...
Gem::Specification.new do |s|
  ...
  s.summary = %q{}
  s.test_files = ["test/schema/test_definition.rb", "test/schema/test_mixin.rb", "test/test_base.rb", "test/test_connection.rb", "test/test_helper.rb", "test/test_invoice.rb", "test/test_expense.rb", "test/test_payment.rb", "test/test_list_proxy.rb", "test/test_page.rb"]
